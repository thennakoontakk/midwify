...
class _FetalHealthPatientSelectScreenState
  ...
  Widget _buildPatientCard(PatientData patient) {
    ...
    return Card(
      ...
      child: InkWell(
        borderRadius: BorderRadius.circular(14),
        onTap: () => _showAssessmentMethodPicker(patient),
        child: Padding(
          padding: const EdgeInsets.all(16),
          child: Row(
            children: [
  ...
  void _showAssessmentMethodPicker(PatientData patient) {
                    ...
                    const Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 2),
                          Text(
                              'AI auto-extracts parameters from CTG strip image',
                              style: TextStyle(
                        ...
                        children: [
                          Text('Enter Manually',
                              style: TextStyle(
                                  ...
                                  color: AppColors.textPrimary)),
                          SizedBox(height: 2),
                          Text('Input all 21 CTG parameters with sliders',
                              style: TextStyle(
                                  fontSize: 12, color: AppColors.textMuted)),
                        ],
                      ),
