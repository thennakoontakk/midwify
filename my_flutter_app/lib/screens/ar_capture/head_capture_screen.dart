...
class _HeadCaptureScreenState extends State<HeadCaptureScreen> {
  ...
  Future<void> _processImage(String imagePath) async {
    debugPrint('=== HEAD CAPTURE: Processing image ===');
    ...
    try {
      ...
      if (confidence == 0) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Please ensure the image clearly shows a baby\'s head for accurate analysis.'),
      ...
      debugPrint('=== HEAD CAPTURE: Success - proceeding to diagnosis ===');
  ...
  Widget build(BuildContext context) {
    final t = {
      AppLanguage.en: {
        ...
        'instruction': "Align the guide with the baby's features and keep steady.",
        'processing': "Analyzing AI Model...",
      },
      AppLanguage.si: {
        'title': "හිස විශ්ලේෂණ ඡායාරූපය",
        'instruction': "මාර්ගෝපදේශය ළදරුවාගේ ලක්ෂණ සමඟ පෙළගස්වා ස්ථාවරව තබා ගන්න.",
